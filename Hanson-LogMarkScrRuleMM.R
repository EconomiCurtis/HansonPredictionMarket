...
##########################################
# simulator one ----
# poeple have prior, if cost of new share is lower than prior, buy until out of cash
...
# Book <- dplyr::mutate(
#   Book,
#   Pmove = price - lag(price))
# 
# ################################
# # simulator two, simple -----
# # buy and sell only one share
# 
# Dat <- Bidders(3000,.8,.01)
# Dat$Buy = NA
# Dat$q1 = 0
# Dat$q2 = 0
# Dat$spend = 0
...
#   
#   #buy or sell?
#   if (Price1(base,CurrBook$q1,CurrBook$q2) <= Dati$Prob){
#     action = "Buy"
#   } else {
#     action = "Sell"
#   }
# 
#   
#   #will the user's purchase move price beyond acceptable price?
#   #...
#   
#   if (action == "Buy"){
#     Dati$q1 = 1
#     Dati$spend = TraderPay(base,CurrBook$q1,CurrBook$q2,1)
#   } else {
#     Dati$q2 = 1
#     Dati$spend = TraderPay(base,CurrBook$q2,CurrBook$q1,1)
#   }
#   
#   CurrBook <- data.frame(
#     Time = Dati$Time,
#     q1 = CurrBook$q1 + Dati$q1,
#     q2 = CurrBook$q2 + Dati$q2,
#     income = CurrBook$income + Dati$spend,
#     price = 0,
#     fees = 0.05
#   )
#   CurrBook$price = Price1(base, CurrBook$q1,CurrBook$q2)
#   
#   #update book
#   Book = rbind(
#     Book,
...
# 
# # simulator two ----
# #increase b as our fees increase
# 
# Dat <- Bidders(5000,.8,0.1)
# Dat$Buy = NA
# Dat$q1 = 0
# Dat$q2 = 0
# Dat$spend = 0
# 
# #make cash non-variable
# Dat$Cash = 1
# 
# Book = data.frame(
#   Time = 0,
...
#   
#   #buy or sell?
#   if (Price1(B,CurrBook$q1,CurrBook$q2) < Dati$Prob){
#     action = "Buy"
#   } else {
#     action = "Sell"
#   }
...
#   
#   if (action == "Buy"){
#     Dati$q1 = SharesGot(B, CurrBook$q1, CurrBook$q2, cash * (1 - spread / 2))
#     Dati$spend = TraderPay(B,CurrBook$q1,CurrBook$q2,Dati$q1)
#   } else {
#     Dati$q2 = SharesGot(B, CurrBook$q2, CurrBook$q1, cash * (1 - spread / 2))
#     Dati$spend = TraderPay(B,CurrBook$q2,CurrBook$q1,Dati$q2) #wrong?
#   }
#   
#   CurrBook <- data.frame(
#     Time = Dati$Time,
...
#     income = CurrBook$income + Dati$spend,
#     price = 0,
#     fees = CurrBook$fees + cash - Dati$spend,
#     type = action
#   )
#   
#   B =  base + max(Book$fees)
#   
#   CurrBook$price = Price1(B, CurrBook$q1,CurrBook$q2)
#   
#   #update book
#   Book = rbind(
#     Book,
